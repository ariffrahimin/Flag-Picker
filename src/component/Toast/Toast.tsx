...
const Toast = () => {
  ...
  return (
    <div id="toast-danger" className=" animate-bounce ease-in-out flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-red-200 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
